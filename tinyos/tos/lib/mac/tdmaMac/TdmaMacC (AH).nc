...
implementation {
	...
	components new QueueC(notification_t *, 1) as notifyQueueC;
	//components PrintfC;
	...
	TdmaMacP.forwardNotifyQueue -> notifyQueueC;
	...
	TdmaMacP.GlobalTime -> BackGroundSync;
	TdmaMacP.TimeSyncInfo -> BackGroundSync;
	TdmaMacP.TimeSyncMode -> BackGroundSync;

	//TdmaMacP.phyNotificationReceive -> BackGroundSync.Receive;
	TdmaMacP.SyncAlarm -> Alarm32khz32C;
	components LedsC;
	TdmaMacP.Leds -> LedsC;
	...
	TdmaMacP.HIforwardQ -> HIQueueC;
	TdmaMacP.LOforwardQ -> LOQueueC;
	TdmaMacP.RootQ -> RootQueueC;

	components AdaptiveHART_UtilC;
	TdmaMacP.AH_Util -> AdaptiveHART_UtilC;
	// For offset algorithm
	components CC2420ReceiveC;
	TdmaMacP.ReceiveIndicator -> CC2420ReceiveC;
	components new Alarm32khz16C() as relay_alarm;
	components new Alarm32khz16C() as root_alarm;
	TdmaMacP.TxOffset_relay -> relay_alarm;
	TdmaMacP.TxOffset_root-> root_alarm;

	components LocalTime32khzC;
	TdmaMacP.dbg_timer -> LocalTime32khzC;
	TdmaMacP.dbg_timer2 -> TimerMilliC;
